...
public class telaEquacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblB.setForeground(new java.awt.Color(179, 11, 2));
        lblB.setText("B");

        lblA.setFont(new java.awt.Font("Noto Sans", 0, 24)); // NOI18N
        lblA.setForeground(new java.awt.Color(179, 11, 2));
        lblA.setText("A");

        lblC.setFont(new java.awt.Font("Noto Sans", 0, 24)); // NOI18N
        lblC.setForeground(new java.awt.Color(179, 11, 2));
        lblC.setText("C");
        ...
        lblDelta.setForeground(new java.awt.Color(11, 191, 28));
        lblDelta.setText("0");

        lblRaiz.setFont(new java.awt.Font("Noto Sans", 1, 18)); // NOI18N
        lblRaiz.setForeground(new java.awt.Color(11, 191, 28));
        lblRaiz.setText("0");
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        lblDelta.setText(String.format("%.1f", d));   //como queremos com duas casas decimais, não usamos Double.toString(), e sim o String.format()
